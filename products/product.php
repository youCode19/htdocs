    ...
    <div class="row g-5">
        ...
        <div class="col-md-6">
            <div class="neumorphic p-3 rounded-3">
                <img src="/htdocs/assets/img/products/<?= htmlspecialchars($product['image']) ?>" 
        ...
        <div class="col-md-6">
            <div class="neumorphic p-4 rounded-3">
                ...
                <form action="/htdocs/cart/add.php" method="POST" class="mb-4" id="add-to-cart-form">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="/htdocs/products/category.php?slug=<?= urlencode($product['category_slug']) ?>" class="text-decoration-none">
...
document.getElementById('add-to-cart-form')?.addEventListener('submit', function(e) {
    ...
    submitButton.innerHTML = '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Ajout...';
    ...
    .then(response => {
        ...
        submitButton.className = 'btn btn-success flex-grow-1 py-3';
    ...
    .catch(() => {
        document.getElementById('cart-message').innerHTML = '<div class="alert alert-danger">Erreur lors de l\'ajout au panier.</div>';
        submitButton.className = originalClass;
        submitButton.innerHTML = originalText;
        submitButton.disabled = false;
    });
